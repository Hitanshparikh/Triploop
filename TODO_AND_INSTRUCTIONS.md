...
| **8. Activity/City Search**    |   ⏳ To-Do   | `pages/city-search.php`, `pages/activity-...`    | Search interface for activities (e.g. Paragliding) and cities with detailed result cards and extensive Group/Filter/Sort.            |
